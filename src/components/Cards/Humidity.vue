<template>
  <div
    class="highlights-item col-md-4 col-sm-6 col-xs-12 border-top"
    style="background-color: #606876;"
  >
    <div>
      <fusioncharts
        type="line"
...
export default {
  ...
  methods: {
    setChartData: function() {
      var data = [];
      for (var i = 0; i < 10; i++) {
        console.log(DateFo.messageDate(this.highlights.hourly.data[i].time));
        var dataObject = {
          label: DateFo.messageDate(this.highlights.hourly.data[i].time),
          value: this.highlights.hourly.data[i].humidity
        };
